...
Rndr::Matrix4x4f Rndr::Canvas::Orthographic(f32 left, f32 right, f32 bottom, f32 top, f32 near, f32 far)
{
    Matrix4x4f mat(1.0f);
...
Rndr::Matrix4x4f Rndr::Canvas::Perspective(f32 vertical_fov, f32 aspect_ratio, f32 near, f32 far)
{
