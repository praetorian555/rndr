...
Rndr::FormatNumericClass Rndr::GetFormatNumericClass(PixelFormat format)
{
    switch (format)
    {
        // Normalised, scaled, sRGB and floating point formats all arrive in the shader as floats.
        case PixelFormat::R4G4_UNORM_PACK8:
        case PixelFormat::R8_UNORM:
        case PixelFormat::R8_SNORM:
        case PixelFormat::R8_USCALED:
        ...
        case PixelFormat::ASTC_12x12_SRGB_BLOCK:
            return FormatNumericClass::Float;

        // Signed integers, read by an int input.
        case PixelFormat::R8_SINT:
        case PixelFormat::R8G8_SINT:
        case PixelFormat::R16_SINT:
        case PixelFormat::R8G8B8_SINT:
        ...
        case PixelFormat::R64G64B64_SINT:
        case PixelFormat::R64G64B64A64_SINT:
            return FormatNumericClass::SignedInt;

        // Unsigned integers, read by a uint input.
        case PixelFormat::R8_UINT:
        case PixelFormat::R8G8_UINT:
        case PixelFormat::R16_UINT:
        case PixelFormat::R8G8B8_UINT:
