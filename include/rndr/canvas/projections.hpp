...
/**
 * Create an orthographic projection matrix for a right-handed view space, switching to a
 * left-handed coordinate system where Z maps between -1 and 1.
 *
 ...
 *
 * Example:
 *      Matrix4x4f projection = Canvas::Orthographic(-500.0f, 500.0f, -100.0f, 100.0f, 0.1f, 100.0f);
 */
Matrix4x4f Orthographic(f32 left, f32 right, f32 bottom, f32 top, f32 near, f32 far);

/**
 * Create a perspective projection matrix for a right-handed view space, switching to a
 * left-handed coordinate system where Z maps between -1 and 1.
 *
 ...
 *
 * Example:
 *      Matrix4x4f projection = Canvas::Perspective(60.0f, width / height, 0.1f, 100.0f);
 */
Matrix4x4f Perspective(f32 vertical_fov, f32 aspect_ratio, f32 near, f32 far);
