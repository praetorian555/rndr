...
// ImageLayout, ImageAspectBits, ImageSubresourceRange, PipelineStageBits and PipelineStageAccessBits are
// Vulkan concepts and live in rndr/forge/types.hpp, in the Rndr::Forge namespace.
